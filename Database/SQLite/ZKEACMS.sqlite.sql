-- Script Date: 2021/7/17 星期六 12:24  - ErikEJ.SqlCeScripting version 3.5.2.56
SELECT 1;
...
, [LastUpdateByName] nvarchar(100) NULL
, [LastUpdateDate] datetime NULL
, CONSTRAINT [PK__Subscrip__3214EC27F2CF7A50] PRIMARY KEY ([ID])
);
...
, [LastUpdateByName] nvarchar(100) NULL
, [LastUpdateDate] datetime NULL
, CONSTRAINT [PK__Shipping__3214EC277AE1C2DC] PRIMARY KEY ([ID])
);
...
, [LastUpdateByName] nvarchar(100) NULL
, [LastUpdateDate] datetime NULL
, CONSTRAINT [PK__Roles__3214EC27830A38C4] PRIMARY KEY ([ID])
);
CREATE TABLE [UserRoleRelation] (
  [ID] INTEGER NOT NULL
, [RoleID] int NULL
, [UserID] nvarchar(50) NULL
, CONSTRAINT [PK__UserRole__3214EC27D1F39BF4] PRIMARY KEY ([ID])
...
, [LastUpdateByName] nvarchar(100) NULL
, [LastUpdateDate] datetime NULL
, CONSTRAINT [PK__ProductG__3214EC2762D12503] PRIMARY KEY ([ID])
);
...
, CONSTRAINT [PK__PersistK__3214EC270CAFCF9B] PRIMARY KEY ([ID])
);
...
, [LastUpdateByName] nvarchar(100) NULL
, [LastUpdateDate] datetime NULL
, CONSTRAINT [PK__FluidCon__3214EC272393AF27] PRIMARY KEY ([ID])
);
...
, [Revision] int NULL
, [Build] int NULL
, CONSTRAINT [PK__DBVersio__3214EC2741CCCF74] PRIMARY KEY ([ID])
);
...
, [LastUpdateByName] nvarchar(100) NULL
, [LastUpdateDate] datetime NULL
, CONSTRAINT [PK__Currency__3214EC27606047E0] PRIMARY KEY ([ID])
);
...
, [LastUpdateByName] nvarchar(100) NULL
, [LastUpdateDate] datetime NULL
, CONSTRAINT [PK__ArticleG__3214EC27A1D92785] PRIMARY KEY ([ID])
);
...
INSERT INTO [DBVersion] ([ID],[Major],[Minor],[Revision],[Build]) VALUES (1,3,4,3,0);
