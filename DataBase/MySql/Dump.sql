...
('TabWidget@AssemblyName','zh-CN','AssemblyName','TabWidget','EntityProperty'),
('TabWidget@IsSystem','zh-CN','IsSystem','TabWidget','EntityProperty'),
...
('TabWidget@ServiceTypeName','zh-CN','ServiceTypeName','TabWidget','EntityProperty'),
('TabWidget@StyleClass','zh-CN','自定义样式','TabWidget','EntityProperty'),
('TabWidget@TabItems','zh-CN','标签项','TabWidget','EntityProperty'),
('TabWidget@Thumbnail','zh-CN','模板缩略图','TabWidget','EntityProperty'),
('TabWidget@Title','zh-CN','标题','TabWidget','EntityProperty'),
('TabWidget@ViewModelTypeName','zh-CN','ViewModelTypeName','TabWidget','EntityProperty'),
