...
begin
EXEC [ZKEACMS_Core].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [ZKEACMS_Core] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET ARITHABORT OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [ZKEACMS_Core] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [ZKEACMS_Core] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET  DISABLE_BROKER 
GO
ALTER DATABASE [ZKEACMS_Core] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [ZKEACMS_Core] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [ZKEACMS_Core] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [ZKEACMS_Core] SET  MULTI_USER 
GO
ALTER DATABASE [ZKEACMS_Core] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [ZKEACMS_Core] SET DB_CHAINING OFF 
GO
EXEC sys.sp_db_vardecimal_storage_format N'ZKEACMS_Core', N'ON'
GO
USE [ZKEACMS_Core]
GO
SET ANSI_NULLS ON
...
USE [master]
GO
ALTER DATABASE [ZKEACMS_Core] SET  READ_WRITE 
GO
