...
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'Everything goes well.', N'zh-CN', N'没有错误日志，程序运行一切正常', NULL, NULL)
...
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'Title', N'zh-CN', N'名称', NULL, NULL)
