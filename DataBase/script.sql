...
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'PageAsset@Url', N'zh-CN', N'Url', N'PageAsset', N'EntityProperty')
...
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'TabWidget@AssemblyName', N'zh-CN', N'AssemblyName', N'TabWidget', N'EntityProperty')
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'TabWidget@IsSystem', N'zh-CN', N'IsSystem', N'TabWidget', N'EntityProperty')
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'TabWidget@IsTemplate', N'zh-CN', N'保存为模板', N'TabWidget', N'EntityProperty')
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'TabWidget@PartialView', N'zh-CN', N'显示模板', N'TabWidget', N'EntityProperty')
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'TabWidget@Position', N'zh-CN', N'排序', N'TabWidget', N'EntityProperty')
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'TabWidget@ServiceTypeName', N'zh-CN', N'ServiceTypeName', N'TabWidget', N'EntityProperty')
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'TabWidget@StyleClass', N'zh-CN', N'自定义样式', N'TabWidget', N'EntityProperty')
...
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'TabWidget@Thumbnail', N'zh-CN', N'模板缩略图', N'TabWidget', N'EntityProperty')
...
INSERT [dbo].[Language] ([LanKey], [CultureName], [LanValue], [Module], [LanType]) VALUES (N'TabWidget@ViewModelTypeName', N'zh-CN', N'ViewModelTypeName', N'TabWidget', N'EntityProperty')
